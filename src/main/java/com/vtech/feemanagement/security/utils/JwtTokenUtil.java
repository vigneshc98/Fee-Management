package com.vtech.feemanagement.security.utils;
...
//	 Algorithm.HMAC256("secretkey@feeM1234".getBytes());
	...
	public DecodedJWT getAllClaimsFromToken(String token) {
	 ...
	 public String generateAccessToken(AppUser user) throws InvalidKeySpecException, NoSuchAlgorithmException {
...
//					.withClaim("roles", user.getAuthorities())
	 ...
	 public String generateRefreshToken(AppUser user) throws InvalidKeySpecException, NoSuchAlgorithmException {
